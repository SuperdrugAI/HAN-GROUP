...
# 加载数据
data = pd.read_csv(r'C:\Users\hp\Desktop\ZSM 数据 代码 图\临床尿液.csv', encoding='gb2312')
...
labels = ['E.faecalis', 'Healthy', 'E.coli']
...
disp.plot(cmap='Blues', values_format='d')  # 修改此处
